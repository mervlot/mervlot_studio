    ...
    return (
        ...
        >
            ...
            >
                {items.map((item, i) => (
                    <div
                        className="flex items-center justify-center text-xl font-semibold text-center border-2 shadow-lg text-shadow-lg dark:text-shadow-[#3a3939] dark:text-white dark:shadow-[#161515] border-white dark:border-[#181717] rounded-[15px] select-none box-border relative w-full"
                        key={i}
                        style={{
